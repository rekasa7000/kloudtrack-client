...
import { FieldInfo } from "@/utils/field-info"; // Assuming this exists for error display
...
const UserProfile = () => {
  const form = useForm({
    ...
    onSubmit: async ({ value }) => {
      ...
      // Here you would typically send the data to a backend and update the lastUpdated timestamp
    },
  });
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <Card className="border rounded-lg shadow-sm">
          ...
          <CardContent className="flex flex-col items-center space-y-4 p-6">
            <div className="w-40 h-40 bg-gray-300 rounded-full border-4 border-yellow-500 flex items-center justify-center">
