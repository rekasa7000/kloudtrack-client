...
const TenantForm = () => {
  ...
  return (
    <div className="border border-muted rounded-lg py-5  mx-auto container max-h-2xl gap-4 w-full flex flex-col items-center justify-center bg-white shadow-sm mt-2">
      {currentStep === 1 ? (
        <React.Fragment>
        ...
        <form className="max-w-2xl mx-auto flex flex-col items-stretch w-full gap-4 p-4">
          <h1 className="font-inter font-medium text-lg">Role and Organization</h1>
