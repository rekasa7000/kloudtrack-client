      ...
      <div className="py-4 px-0 w-full flex items-center justify-between mt-2">
        ...
        <div className="flex flex-col justify-center">
          ...
          <p className="text-sm font-montserrat text-muted-foreground">
            An <span className="font-semibold">automated weather</span> station located at Brgy. San Jose, Balanga City, Bataan
          </p>
        </div>
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-2">
            <Switch id="show-dots" />
            <Label className="text-sm font-inter" htmlFor="show-dots">Show Dots</Label>
          </div>
