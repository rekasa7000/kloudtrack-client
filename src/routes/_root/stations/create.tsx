...
function RouteComponent() {
  ...
  useEffect(() => {
    if (lngLat) {
      form.setFieldValue("longitude", lngLat.lng.toFixed(6));
      form.setFieldValue("latitude", lngLat.lat.toFixed(6));
    }
  }, [lngLat, form]);

  useEffect(() => {
    if (locationInfo) {
      form.setFieldValue("address", locationInfo.place_name || "");
      form.setFieldValue("city", locationInfo.place || "");
      form.setFieldValue("state", locationInfo.region || "");
      form.setFieldValue("country", locationInfo.country || "");
    }
  }, [locationInfo, form]);
